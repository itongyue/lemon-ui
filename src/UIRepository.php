...
class UIRepository implements ArrayAccess
{
    ...
    protected $resources = [
        ...
        'jquery-migrate' => ['js/plugin/jquery-migrate.js','scope'=>'header'],
        ...
        'icheck'      => ['css/icheck/minimal/blue.css', 'js/plugins/icheck.min.js','scope'=>'header'],
        'colorpicker' => ['css/plugins/bootstrap-colorpicker.css', 'js/plugins/bootstrap-colorpicker.js','scope'=>'header'],
        'inputmask'   => ['css/plugins/inputmask.css', 'js/plugins/inputmask/inputmask.js', 'js/plugins/inputmask/inputmask.extensions.js','scope'=>'header'],
        'inputmask.phone' => ['js/plugins/inputmask/inputmask.phone.extensions.js','scope'=>'header'],
        'inputmask.date' => ['js/plugins/inputmask/inputmask.date.extensions.js','scope'=>'header'],
        'inputmask.numeric' => ['js/plugins/inputmask/inputmask.numeric.extensions.js','scope'=>'header'],
        'inputmask.regex' => ['js/plugins/inputmask/inputmask.regex.extensions.js','scope'=>'header'],
        'inputmask.jquery' => ['js/plugins/inputmask/jquery.inputmask.js','scope'=>'header'],
        'maxlength'   => ['js/plugins/bootstrap-maxlength.js','scope'=>'header'],
        'moment'      => ['js/moment.js','scope'=>'header'],
        'lodash'      => ['js/lodash.js','scope'=>'header'],
        'datepicker'  => ['css/plugins/bootstrap-datepicker.css', 'js/plugins/bootstrap-datepicker.js','scope'=>'header'],
        'daterangepicker' => ['css/plugins/bootstrap-daterangepicker.css', 'js/plugins/bootstrap-daterangepicker.js','scope'=>'header'],
        'datetimepicker' => ['css/plugins/bootstrap-datetimepicker.css', 'js/plugins/bootstrap-datetimepicker.js','scope'=>'header'],
        'timepicker'  => ['css/plugins/bootstrap-timepicker.css', 'js/plugins/bootstrap-timepicker.js','scope'=>'header'],
        'ckeditor'    => ['ckeditor/ckeditor.js', 'ckeditor/config.js','scope'=>'header'],
        'kvsortable'  => ['js/plugins/bootstrap-fileinput/plugins/sortable.js','scope'=>'header'],
        'fileinput'   => ['css/plugins/bootstrap-fileinput.css', 'js/plugins/bootstrap-fileinput/fileinput.js', 'js/plugins/bootstrap-fileinput/plugins/piexif.js', 'js/plugins/bootstrap-fileinput/plugins/purify.js','scope'=>'header'],
        'numberinput' => ['js/plugins/bootstrap-input-spinner.js','scope'=>'header'],
        'select2'     => ['css/plugins/select2.css', 'js/plugins/select2.min.js','scope'=>'header'],
        'rangeSlider' => ['css/ion-rangeslider/ion.rangeSlider.css', 'css/ion-rangeslider/ion.rangeSlider.skinNice.css', 'js/plugins/ion.rangeSlider.min.js','scope'=>'header'],
        'slider'      => ['css/plugins/bootstrap-slider.css', 'js/plugins/bootstrap-slider.js','scope'=>'header'],
        'switch'      => ['css/plugins/bootstrap-switch.css', 'js/plugins/bootstrap-switch.js','scope'=>'header'],

        'smartWizard' => ['css/smartwizard/smart_wizard.css', 'js/plugins/jquery.smartWizard.js','scope'=>'header'],
        'smartWizard.arrows' => ['css/smartwizard/smart_wizard_theme_arrows.css','scope'=>'header'],
        'smartWizard.circles' => ['css/smartwizard/smart_wizard_theme_circles.css','scope'=>'header'],
        'smartWizard.dots' => ['css/smartwizard/smart_wizard_theme_dots.css','scope'=>'header'],

        'chart'       => ['js/plugins/chart.js','scope'=>'header'],
        'fullcalendar'=> ['css/plugins/fullcalendar.min.css', 'css/plugins/fullcalendar.print.min.css','scope'=>'header'],
        'jvectormap'  => ['css/plugins/jquery-jvectormap.css', 'js/plugins/jvectormap/jvectormap.js','scope'=>'header'],
        'morris'      => ['css/plugins/morris.css', 'js/plugins/morris.js','scope'=>'header'],
        'toastr'      => ['css/plugins/toastr.css', 'js/plugins/toastr.js','scope'=>'header'],
        'pace'        => ['js/plugins/pace.js','scope'=>'header'],
        'slimscroll'  => ['css/plugins/slimscroll.css', 'js/plugins/slimscroll.js','scope'=>'header'],
        'raphael'     => ['js/plugins/raphael.js','scope'=>'header'],

        'jquery.knob' => ['js/plugins/jquery.knob.js','scope'=>'header'],
        'jquery.mousewheel' => ['js/plugins/jquery.mousewheel.js','scope'=>'header'],
        'jquery.nestable' => ['js/plugins/jquery.nestable.js','scope'=>'header'],
        'jquery.slimscroll' => ['js/plugins/jquery.slimscroll.js','scope'=>'header'],
        'jquery.sparkline' => ['js/plugins/jquery.sparkline.js','scope'=>'header'],

        'datatable'   => ['css/dataTables/dataTables.bootstrap.min.css', 'js/dataTables/jquery.dataTables.js','scope'=>'header'],
        'datatable.responsive'=> ['datatable', 'css/dataTables/plugins/responsive.bootstrap.min.css', 'js/dataTables/plugins/dataTables.responsive.js','scope'=>'header'],
        'datatable.fixedColumns' => ['datatable', 'css/dataTables/plugins/fixedColumns.bootstrap.min.css', 'js/dataTables/plugins/dataTables.fixedColumns.js','scope'=>'header'],
        'datatable.fixedHeader' => ['datatable', 'css/dataTables/plugins/fixedHeader.bootstrap.min.css', 'js/dataTables/plugins/dataTables.fixedHeader.js','scope'=>'header'],
        'datatable.rowReorder' => ['datatable', 'css/dataTables/plugins/rowReorder.bootstrap.min.css', 'js/dataTables/plugins/dataTables.rowReorder.js','scope'=>'header'],
        'datatable.colReorder' => ['datatable', 'css/dataTables/plugins/colReorder.bootstrap.min.css', 'js/dataTables/plugins/dataTables.colReorder.js','scope'=>'header'],
        'datatable.keyTable' => ['datatable', 'css/dataTables/plugins/keyTable.bootstrap.min.css', 'js/dataTables/plugins/dataTables.keyTable.js','scope'=>'header'],
        'datatable.rowGroup' => ['datatable', 'css/dataTables/plugins/rowGroup.bootstrap.min.css', 'js/dataTables/plugins/dataTables.rowGroup.js','scope'=>'header'],
        'datatable.scroller' => ['datatable', 'css/dataTables/plugins/scroller.bootstrap.min.css', 'js/dataTables/plugins/dataTables.scroller.js','scope'=>'header'],
        'datatable.select' => ['datatable', 'css/dataTables/plugins/select.bootstrap.min.css', 'js/dataTables/plugins/dataTables.select.js','scope'=>'header']
